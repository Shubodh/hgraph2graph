...
from hgraph.encoder_metal import IncHierMPNEncoderMetal
...
class HierMPNDecoderMetal(nn.Module):
    ...
    def __init__(self, vocab, avocab, rnn_type, embed_size, hidden_size, latent_size, depthT, depthG, dropout, attention=False):
        ...
        self.hmpn = IncHierMPNEncoderMetal(vocab, avocab, rnn_type, embed_size, hidden_size, depthT, depthG, dropout)
