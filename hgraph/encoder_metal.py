...
class HierMPNEncoderMetal(nn.Module):
    def __init__(self, vocab, avocab, rnn_type, embed_size, hidden_size, depthT, depthG, dropout):
        ...
        self.tree_encoder = MPNEncoder(rnn_type, hidden_size + MolGraphMetal.MAX_POS, hidden_size, hidden_size, depthT, dropout)
        self.inter_encoder = MPNEncoder(rnn_type, hidden_size + MolGraphMetal.MAX_POS, hidden_size, hidden_size, depthT, dropout)
...
class IncHierMPNEncoderMetal(HierMPNEncoderMetal):

    def __init__(self, vocab, avocab, rnn_type, embed_size, hidden_size, depthT, depthG, dropout):
        super(IncHierMPNEncoderMetal, self).__init__(vocab, avocab, rnn_type, embed_size, hidden_size, depthT, depthG, dropout)
        self.tree_encoder = IncMPNEncoder(rnn_type, hidden_size + MolGraphMetal.MAX_POS, hidden_size, hidden_size, depthT, dropout)
        self.inter_encoder = IncMPNEncoder(rnn_type, hidden_size + MolGraphMetal.MAX_POS, hidden_size, hidden_size, depthT, dropout)
